...
test_pre="/opt/openmpi/1.6/bin/mpiexec -np 2 --mca pml ob1 --mca btl openib,sm,self --mca btl_openib_verbose 1 --hostfile /home/derek/benchmarks/mpi/hosts/pleiades_all_hosts $test_dir"
test_cmd=""
